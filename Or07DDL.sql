...
insert into tb_member values (2, 'kosmo1', '1234', '코스모156기',
    'kosmo156@gmail.com');
insert into tb_member values (3, 'kosmo1', '1234', '코스모157기',
    'kosmo157@nate.com');
--삽입된 레코드 확인하기
select * from tb_member;
--명시적 true조건이므로 모든 레코드를 대상으로 인출한다.
select * from tb_member where 1=1;
--명시적 false조건이므로 모든 레코드를 인출하지 않는다.
